...
class dlt_model:
    ...
    def __init__(self,input_info):
        ...
        self.hgt_penalty = input_info.hgt_penalty*penalty_scale
        self.spc_penalty = input_info.spc_penalty*penalty_scale
        self.dup_penalty = input_info.dup_penalty*penalty_scale
        self.los_penalty = input_info.los_penalty*penalty_scale
        """
